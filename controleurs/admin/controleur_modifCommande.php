<?php
	...
	if(isset($_POST['modif'])){
		...
		$date_livraison	   	= htmlentities(trim($_POST['date_livraison']));
		...
		$ModifierProduits = new Commande($id_commande,$nom_commande,$mois_commande,$annee_commande,$date_commande,$date_livraison,$photo,$paye,$id_client);
	
		$reponse = $ModifierProduits->ModifierCommande();
		
		if($reponse){
			header('location:?c=cnxComm');
		}
	}
	if(isset($_GET['code'])){
